...
import 'package:news_app/features/daily_news/domain/usecase/get_saved_article.dart';
import 'package:news_app/features/daily_news/domain/usecase/remove_article.dart';
import 'package:news_app/features/daily_news/domain/usecase/save_article.dart';
...
class LocalArticleBloc extends Bloc<LocalArticleEvent, LocalArticleState>{
  ...
  LocalArticleBloc(this._getSavedArticleUseCase, this._saveArticleUseCase, this._removeArticleUseCase) : super(const LocalArticleLoading()){
